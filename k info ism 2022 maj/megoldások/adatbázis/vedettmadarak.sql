...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2024 at 09:27 AM
...
--
-- Database: `vedettmadarak`
--

-- --------------------------------------------------------

--
-- Table structure for table `csalad`
--

CREATE TABLE `csalad` (
  `id` int(11) NOT NULL,
  `nev` varchar(20) NOT NULL,
  `latin` varchar(17) NOT NULL,
  `rendId` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;

--
-- Dumping data for table `csalad`
--

INSERT INTO `csalad` (`id`, `nev`, `latin`, `rendId`) VALUES
...
--
-- Table structure for table `faj`
--

CREATE TABLE `faj` (
  `id` int(11) NOT NULL,
  `nev` varchar(45) NOT NULL,
  `latin` varchar(23) NOT NULL,
  `csaladId` int(11) NOT NULL,
  `ertek` int(11) NOT NULL,
  `evszam` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;

--
-- Dumping data for table `faj`
--

INSERT INTO `faj` (`id`, `nev`, `latin`, `csaladId`, `ertek`, `evszam`) VALUES
...
--
-- Table structure for table `rend`
--
...
--
-- Dumping data for table `rend`
--

INSERT INTO `rend` (`id`, `nev`, `latin`) VALUES
...
--
-- Indexes for table `csalad`
--
ALTER TABLE `csalad`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nev` (`nev`),
  ADD UNIQUE KEY `latin` (`latin`),
  ADD KEY `fk_csaladrend` (`rendId`);

--
-- Indexes for table `faj`
--
ALTER TABLE `faj`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nev` (`nev`),
  ADD UNIQUE KEY `latin` (`latin`),
  ADD KEY `fk_fajcsalad` (`csaladId`);

--
-- Indexes for table `rend`
--
ALTER TABLE `rend`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nev` (`nev`),
...
--
-- Constraints for table `csalad`
--
ALTER TABLE `csalad`
  ADD CONSTRAINT `fk_csaladrend` FOREIGN KEY (`rendId`) REFERENCES `rend` (`id`);

--
-- Constraints for table `faj`
--
ALTER TABLE `faj`
  ADD CONSTRAINT `fk_fajcsalad` FOREIGN KEY (`csaladId`) REFERENCES `csalad` (`id`);
COMMIT;
